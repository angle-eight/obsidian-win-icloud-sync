...
実iCloudを使う24時間常駐試験は [docs/soak-test.md](docs/soak-test.md) の手順で実施します。`scripts/Start-SoakTest.ps1` がプロセス数、メモリ、ハンドル、スレッド、ログ・バックアップ容量を採取し、`scripts/Summarize-SoakTest.ps1` が増減とログ上の重複同期を集計します。
...
設計と今後の実装順は `docs/plan.md` を参照してください。
